...
(function () {
  ...
  // Added options at Ver1.1.0
  var specialSwitchId = Number(parameters['Original Situation Switch ID'] || 1);
  var specialStepSe = {};
  ...
  specialStepSe.interval = Number(parameters['Original Situation Interval'] || 1);
  ...
  Game_Player.prototype.stepSound = function (regionId) {
    var se;
    if (specialSwitchId && $gameSwitches.value(specialSwitchId)) { // Ver1.1.0
