(function () {
    ...
    */
    ...
    Buck_logSp.prototype.redraw = function () {
        ...
        //バックログ上下エリアを追加
        this.bitmap.fillRect(width - 120, height - 180, 0, 0, '#FFDDDD');
        this.bitmap.fillRect(width - 115, height - 100, 0, 0, '#FFFFFF');
        this.bitmap.drawText("", width - 120, height - 180, 70, 70, 'Left');
